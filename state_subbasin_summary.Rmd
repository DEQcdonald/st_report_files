  ...
  knitr::kable(wql_sub, format = table_format, padding = 0, digits = 1, row.names = FALSE,
               caption = tbls(name = paste0(subbasin_name, "_wql"),
                              caption = paste0("Number of water quality impaired stream segments in the ", 
                                               subbasin_name,
                                               " Subbasin for the parameters assessed in this report. Impairments are summarized from the 2018 Integrated Report submitted for EPA approval."))) %>% 
    table_style()
...
Oregon DEQ groups assessment units into five types; streams, lakes, watershed units, estuaries or bays, and coastlines. `r tbls(name = paste0(subbasin_name, "_au_type_sum"), display="cite")` summarizes of the number of attaining, not attaining, and unassessed assessment units by parameter and assessment unit type.
