...
The figure below shows the locations of all of the stations that were queried across the state.
...
`r cat("\n")`    
`r tbls(name="TualatinTribs", caption="Total phosphorus targets in Tualatin River and tributaries")`  

`r knitr::include_graphics(path = "N:/Status_and_Trend_Reports/Lookups_Statewide/TMDL_targets/TualatinTribs.jpg")`  

`r tbls(name="OswegoLake", caption="Total phosphorus targets in Oswego Lake and tributaries")`  

`r knitr::include_graphics(path = "N:/Status_and_Trend_Reports/Lookups_Statewide/TMDL_targets/OswegoLake.jpg")`  
...
```{r stateStatus, include = TRUE, results = 'asis'}
...
au_sum_plot
cat(paste0("\n![", figs(name = paste0("state_au_sum_plot"), caption = paste0("Summary plot of assessment unit status across the state by parameter.")),
           "]()"))
...
stn_sum_plot
cat(paste0("\n![", figs(name = paste0("state_stn_sum_plot"), caption = paste0("Summary plot of station status across the state by parameter.")),
           "]()"))
