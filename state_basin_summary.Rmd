...
if(name == "Columbia River"){
  ...
  basin_wql_streams_lines <- basin_wql_streams_lines %>% dplyr::filter(AU_ID %in% columbia_aus)
  basin_wql_streams_ws <- basin_wql_streams_ws %>% dplyr::filter(AU_ID %in% columbia_aus)
  ...
  basin_wql_streams_lines <- basin_wql_streams_lines %>% dplyr::filter(AU_ID %in% snake_aus)
  basin_wql_streams_ws <- basin_wql_streams_ws %>% dplyr::filter(AU_ID %in% snake_aus)
