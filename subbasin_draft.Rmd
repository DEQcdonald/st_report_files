...
#              ) %>% kableExtra::kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
} else {cat("There are no Category 4A or Category 5 stream segments in this subbasin.")}
...
```{r status, include = TRUE, results = 'asis'}

cat(paste0("There are ", length(unique(par_sum_au$AU_ID)), " assessment units within the ", subbasin_name, " subbasin that were included in this report. The following table summarizes the number of attaining, not attaining, and unassessed assessment units by parameter.\n\n"))
...
cat(paste0("\n![", figs(name = paste0(subbasin_name, "_au_sum_plot"), caption = paste0("Summary plot of assessment unit status within the ", subbasin_name, " Subbasin by parameter.")),
           "]()"))
...
cat(paste0("\n\nOregon DEQ groups assessment units into four types; streams, lakes, watershed units, or estuaries and bays. Below is a summary of the number of attaining, not attaining, and unassessed assessment units by parameter and assessment unit type.\n\n"))
...
cat(paste0("\n\nThere are ", length(unique(par_sum$MLocID)), " stations within the ", subbasin_name, " subbasin that were included in this report. The following table summarizes the number of attaining, not attaining, and unassessed stations by parameter.\n\n"))
...
cat(paste0("\n![", figs(name = paste0(subbasin_name, "_stn_sum_plot"), caption = paste0("Summary plot of station status within the ", subbasin_name, " Subbasin by parameter.")),
           "]()"))
...
cat(paste0("\n\nA summary of the trends within parameters is shown in the table below. Note that trend requires significantly more data than status and may result in many stations with insuffient data for trend analysis.\n\n"))
